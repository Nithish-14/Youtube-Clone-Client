...
import { HomeContainer, HomeVideoListContainer, LoaderContainer, HorizontalScrollContainer, RouteHeading, RouteHeadingContainer,  FailureViewButton, FailureViewHeading, FailureViewImage, FailureViewPara } from '../Home/styledComponents';
...
class FashionBeauty extends Component {
    state = {homeVideos: [], apiStatus: apiStatus.initial, searchInput: 'Learning'}
                            ...
                            <HomeContainer>
                                ...
                                <HorizontalScrollContainer width={showSidebar.toString()}>
                                    <RouteHeadingContainer>
                                        <RouteHeading>Learning</RouteHeading>
                                    </RouteHeadingContainer>
