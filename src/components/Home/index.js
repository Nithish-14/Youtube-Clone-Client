...
import { HomeContainer, HomeVideoListContainer, LoaderContainer, HorizontalScrollContainer, FailureViewImage, FailureViewHeading, FailureViewPara, FailureViewButton } from './styledComponents';
...
class Home extends Component {
    state = {homeVideos: [], apiStatus: apiStatus.initial, searchInput: 'latest'}
    ...
    updateSelectedCategory = (value) => {
        this.setState({searchInput: value === "Home" ? "" : value}, this.getVideos)
    }
                        ...
                        <>
                            ...
                            <HomeContainer>
                                ...
                                <HorizontalScrollContainer width={showSidebar.toString()}>
                                    <HorizontalScroll updateSelectedCategory={this.updateSelectedCategory} />
